    ...
    <div class="col-lg-12 upload ">
        <form class=" frm">
            ...
            <div class="q_block">
                ...
                <input type="text" name="name" id="U_name" class="input" placeholder="User name" readonly>
                <input type="text" name="mail" id="U_mail" class="input" placeholder="User Email" readonly>
                <input type="text" name="pass" id="U_pass" class="input" value="********" placeholder="Password" readonly>
